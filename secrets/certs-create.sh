...
# Generate CA key
openssl req -new -x509 -keyout snakeoil-ca-1.key -out snakeoil-ca-1.crt -days 365 -subj '/CN=acme.org/OU=Technology/O=Acme/L=Munich/ST=BY/C=DE' -passin pass:mypassword -passout pass:mypassword
...
#
users=(confluent-registry client)
